module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uncss: {
      styles: {
        files: {
          'target/<%= meta.css %>/<%= pkg.name %>.css': ['target/www/*.html']
        }
      }
    },
    imageEmbed: {
    ...
    cssmin: {
      styles: {
        files: {
          'target/<%= meta.css %>/<%= pkg.name %>.css': [ 'target/<%= meta.css %>/<%= pkg.name %>.css' ]
        }
      }
    },
    clean: {
  ...
  grunt.registerTask('build', [ 'clean', 'jshint', 'copy', 'less_imports', 'less', 'csslint', 'autoprefixer', 'cmq' ] );
  grunt.registerTask('dist', [ 'build', 'uncss', 'imageEmbed', 'cssmin' ] );
